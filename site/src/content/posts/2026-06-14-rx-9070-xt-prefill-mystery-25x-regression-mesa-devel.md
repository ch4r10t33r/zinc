---
title: "The RX 9070 XT prefill cliff: a 25× Mesa regression hiding in plain sight"
seoTitle: "RX 9070 XT LLM Prefill: 25x Mesa RADV Regression"
date: "2026-06-14"
tags:
  - zinc
  - amd
  ...
  - llama-cpp
keywords:
  - RX 9070 XT LLM prefill regression
  - Mesa 26 RADV DP4a regression
  - RDNA4 GFX1201 Vulkan compute
  - AMD RX 9070 XT local LLM benchmark
  - ZINC vs llama.cpp RDNA4 prefill
  - Qwen3.5 9B prefill tokens per second
  - Vulkan shaderIntegerDotProduct regression
  - cooperative matrix RDNA4 Mesa
  - AMD GPU clock ramp benchmark noise
...
excerpt: "A new RX 9070 XT made ZINC prefill Qwen3.5-9B at 6.8 tok/s while llama.cpp hit 973 tok/s. Decode was fine, which made the bug more interesting: the real culprit was a 25× Mesa 26 DP4a shader regression, isolated with a second RDNA4 card and then cleaned up with a quieter benchmark loop."
seoDescription: "How a 143× ZINC prefill gap on the AMD RX 9070 XT traced back to a 25× Mesa 26 RADV DP4a shader regression, plus the clock-ramp benchmark noise trap and the autonomous loop that took Qwen3.5-9B prefill from 6.8 to 219 tok/s."
draft: false
---
