...
| `ZINC_RT_DIRECT_SSM_Q8_ROW_RANGE_MAX_SUCCESSES` | 0 | Per tracked decode slice cap on consumed direct Q8_0 SSM alpha/beta row-range successes; opt in with a positive value for deeper SSM slice validation |
