...
pub const DmmvDispatch = struct {
    ...
    pub fn recordMulMmQ6KFullDp4a(
        ...
        const use_exact_n64_bm64_acc = accumulate and K == 17408 and N == 64 and (M & 63) == 0 and self.pipeline_mul_mm_q6k_full_dp4a_k17408_n64_bm64_acc != null;
        ...
        if (accumulate and !(use_exact_n64_bm64_acc or use_exact_n64_acc)) return error.PipelineNotLoaded;
        const n_tile: u32 = if (use_exact_n64_bm64_acc)
            64
        ...
        cmd.pushDescAndDispatch(
            ...
            infos[0..],
            std.mem.asBytes(&push),
            if (use_exact_n64_bm64_acc) M / 64 else M / 32,
    ...
    pub fn recordMulMmQ4KGateUpSwigluFullDp4aQ8(
        ...
        const use_ragged_n64 = K == 5120 and N > 64 and (N & 63) != 0 and self.pipeline_mul_mm_q4k_gate_up_swiglu_full_dp4a_q8_k5120_n64_ragged != null;
    ...
    pub fn recordMulMmQ4KGateUpSwigluFullDp4aQ8_1(
        ...
        const use_ragged_n64 = K == 5120 and N > 64 and (N & 63) != 0 and self.pipeline_mul_mm_q4k_gate_up_swiglu_full_dp4a_q8_1_k5120_n64_ragged != null;
    ...
    pub fn recordMulMmQ4KFullDp4a(
        ...
        const use_exact_n64_bm64_acc = accumulate and K == 17408 and N == 64 and (M & 63) == 0 and self.pipeline_mul_mm_q4k_full_dp4a_k17408_n64_bm64_acc != null;
